...
export function HeroStage({
  ...
  return (
    <div className="relative mx-auto mt-10 h-[470px] max-w-[680px] sm:mt-14 sm:h-[600px]">
      ...
      {/* 중앙 폰 mockup — 실제 알림장 표지(메인 슬라이드)를 18:9 비율로 순환 미리보기. */}
      <div className="absolute left-1/2 top-1/2 z-[5] w-[206px] -translate-x-1/2 -translate-y-1/2 -rotate-2 rounded-[24px] bg-[#15110E] p-[3px] shadow-[0_34px_74px_rgba(31,27,23,0.36)] sm:w-[250px]">
        ...
        <div className="relative aspect-[1/2] w-full overflow-hidden rounded-[21px] bg-[#15110E]">
          {active && (
            <div
              key={active.id}
