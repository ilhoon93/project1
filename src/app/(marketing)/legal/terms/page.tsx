  ...
  return (
    <div className="mx-auto max-w-2xl px-5 py-10 text-[#3D2E1F]">
      ...
      <Section title="제6조 (크레딧 및 결제)">
        <ol className="ml-5 list-decimal space-y-1">
          <li>유료 크레딧은 회사가 정한 결제수단(PG·네이버 스마트스토어 등)으로 구매합니다.</li>
      ...
      <Section title="제7조 (청약철회 및 환불)">
        <ol className="ml-5 list-decimal space-y-1">
          <li>
            이용자는 결제일로부터 7일 이내에, <strong>사용하지 않은</strong> 크레딧에 대해
            청약을 철회(환불)할 수 있습니다.
          </li>
          <li>
            디지털 콘텐츠의 특성상 이미 <strong>사용·제공이 개시된</strong> 분(알림장 발행,
            AI 스냅 생성 등 결과물이 제공된 경우)은 청약철회가 제한됩니다(전자상거래법 제17조
            및 콘텐츠 관련 법령에 따름).
          </li>
          <li>
            시스템 오류 등 회사 귀책으로 정상 제공되지 못한 경우 해당 크레딧은 자동
            환원(환불)됩니다.
          </li>
          <li>환불 문의는 제13조의 연락처(네이버 톡톡)로 접수합니다.</li>
        </ol>
      </Section>
